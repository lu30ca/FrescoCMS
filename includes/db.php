 ...
 * @version   1.1
 * 
 * Con qualche fix per integrare la classe con il cms.
 * 
 **/
class MysqliDb{
    /**
    ...
    //Alcuni fix per adattare la classe al cms.
     ...
     * 
     * Fix per poter selezionare anche solo alcuni campi invece dell'intera riga
     */
    public function get($tableName,$fields = '*',$numRows = null)
    {
        $this->_query = "SELECT $fields FROM $tableName";
        $stmt = $this->_buildQuery($numRows);
        $stmt->execute();
        $this->reset();
